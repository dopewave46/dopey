...
/**
 * Placeholder finance context — OWNED by the Finance module (Prompt 07).
 * Kept here as labelled sample data so the project Finance tab and payment
 * status chips have something to show now.
 */
...
export const SAMPLE_PROJECT_FINANCE: Record<string, ProjectFinance> = {
  "proj-01": {
    paid: 90000,
    rows: [
      { id: "inv-201", kind: "Invoice", label: "INV-0201 · 50% advance", amount: 92500, date: days(-20), status: "Paid" },
      { id: "pay-201", kind: "Payment", label: "Bank transfer", amount: 90000, date: days(-2), status: "Received" },
      { id: "inv-202", kind: "Invoice", label: "INV-0208 · on delivery", amount: 92500, date: days(-1), status: "Pending" },
    ],
  },
  "proj-02": {
    paid: 60000,
    rows: [
      { id: "inv-210", kind: "Invoice", label: "INV-0210 · 50% advance", amount: 60000, date: days(-38), status: "Paid" },
      { id: "pay-210", kind: "Payment", label: "UPI", amount: 60000, date: days(-36), status: "Received" },
      { id: "inv-214", kind: "Invoice", label: "INV-0214 · balance", amount: 60000, date: days(-1), status: "Sent" },
    ],
  },
  "proj-03": {
    paid: 65000,
    rows: [
      { id: "inv-218", kind: "Invoice", label: "INV-0218 · full", amount: 65000, date: days(-16), status: "Paid" },
      { id: "pay-218", kind: "Payment", label: "UPI", amount: 65000, date: days(-14), status: "Received" },
    ],
  },
  "proj-04": {
    paid: 240000,
    rows: [
      { id: "inv-120", kind: "Invoice", label: "INV-0120 · full", amount: 240000, date: days(-300), status: "Paid" },
      { id: "pay-120", kind: "Payment", label: "Bank transfer", amount: 240000, date: days(-295), status: "Received" },
    ],
  },
  "proj-05": { paid: 0, rows: [] },
  "proj-06": { paid: 0, rows: [] },
